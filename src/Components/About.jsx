    ...
    >
      <div className="max-w-screen-lg p-4 mx-auto flex flex-col justify-center w-full h-full pt-40">
        ...
        <p className="text-xl mt-10">
          ...
          development, I have a strong command over both front-end and back-end
          technologies, allowing me to build complete and scalable
          applications.On the front-end side, I specialize in HTML, CSS, and
        ...
        <p className="text-xl mt-10">
          ...
          solutions that meet both user requirements and business objectives.I'm
          excited to be part of a team where I can contribute my full stack
